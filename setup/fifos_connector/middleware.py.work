...
from aido_schemas import (EpisodeStart, protocol_agent, protocol_scenario_maker, protocol_simulator_duckiebot1, protocol_simulator, RobotObservations,
...
def main():
    ...
    logger.info("IF THIS PRINTS THEN PROBLEM IS RESOLVED")
    sim_ci.close()
