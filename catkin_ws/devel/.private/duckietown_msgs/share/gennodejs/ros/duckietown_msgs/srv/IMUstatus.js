...
class IMUstatusRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.sensor_position.length;
    return length + 4;
  }
...
class IMUstatusResponse {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.timestamp_acceleration.length;
    length += object.timestamp_gyro.length;
    length += object.timestamp_magnetic_field.length;
    return length + 52;
  }
