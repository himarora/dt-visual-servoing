...
;//! \htmlinclude AprilTagExtended.msg.html

(cl:defclass <AprilTagExtended> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass AprilTagExtended (<AprilTagExtended>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <AprilTagExtended>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'AprilTagExtended)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name duckietown_msgs-msg:<AprilTagExtended> is deprecated: use duckietown_msgs-msg:AprilTagExtended instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AprilTagExtended>))
...
(cl:defmethod transform-val ((m <AprilTagExtended>))
...
(cl:defmethod tag_id-val ((m <AprilTagExtended>))
...
(cl:defmethod tag_family-val ((m <AprilTagExtended>))
...
(cl:defmethod hamming-val ((m <AprilTagExtended>))
...
(cl:defmethod decision_margin-val ((m <AprilTagExtended>))
...
(cl:defmethod homography-val ((m <AprilTagExtended>))
...
(cl:defmethod center-val ((m <AprilTagExtended>))
...
(cl:defmethod corners-val ((m <AprilTagExtended>))
...
(cl:defmethod pose_error-val ((m <AprilTagExtended>))
  ...
  (pose_error m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AprilTagExtended>) ostream)
  "Serializes a message object of type '<AprilTagExtended>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagExtended>) istream)
  "Deserializes a message object of type '<AprilTagExtended>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagExtended>)))
  "Returns string type for a message object of type '<AprilTagExtended>"
  "duckietown_msgs/AprilTagExtended")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagExtended)))
  "Returns string type for a message object of type 'AprilTagExtended"
  "duckietown_msgs/AprilTagExtended")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AprilTagExtended>)))
  "Returns md5sum for a message object of type '<AprilTagExtended>"
  "1ca0d2f82762ea5d7ea60150ab894e3f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AprilTagExtended)))
  "Returns md5sum for a message object of type 'AprilTagExtended"
  "1ca0d2f82762ea5d7ea60150ab894e3f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AprilTagExtended>)))
  "Returns full string definition for message of type '<AprilTagExtended>"
  (cl:format cl:nil "Header header~%geometry_msgs/Transform transform~%int32 tag_id~%string tag_family~%int32 hamming~%float32 decision_margin~%float32[9] homography~%float32[2] center~%float32[8] corners~%float32 pose_error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AprilTagExtended)))
  "Returns full string definition for message of type 'AprilTagExtended"
  (cl:format cl:nil "Header header~%geometry_msgs/Transform transform~%int32 tag_id~%string tag_family~%int32 hamming~%float32 decision_margin~%float32[9] homography~%float32[2] center~%float32[8] corners~%float32 pose_error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <AprilTagExtended>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <AprilTagExtended>))
  "Converts a ROS message object to a list"
  (cl:list 'AprilTagExtended
