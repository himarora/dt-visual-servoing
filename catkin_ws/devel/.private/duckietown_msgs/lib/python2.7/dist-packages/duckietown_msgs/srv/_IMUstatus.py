...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.sensor_position = str[start:end].decode('utf-8')
      else:
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.timestamp_acceleration = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.timestamp_gyro = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.timestamp_magnetic_field = str[start:end].decode('utf-8')
      else:
