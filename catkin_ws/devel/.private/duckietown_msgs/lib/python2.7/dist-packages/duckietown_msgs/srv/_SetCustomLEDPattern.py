...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.pattern.color_mask))
      buff.write(_get_struct_f().pack(self.pattern.frequency))
      length = len(self.pattern.frequency_mask)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.pattern.frequency_mask))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.pattern.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.pattern.color_mask = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      ...
      self.pattern.frequency_mask = struct.unpack(pattern, str[start:end])
      return self
