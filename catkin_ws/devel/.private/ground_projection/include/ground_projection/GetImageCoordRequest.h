...
bool operator==(const ::ground_projection::GetImageCoordRequest_<ContainerAllocator1> & lhs, const ::ground_projection::GetImageCoordRequest_<ContainerAllocator2> & rhs)
{
