...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /duckietown/catkin_ws/src/dt-core/packages/navigation)
  set(navigation_DEVEL_PREFIX /duckietown/catkin_ws/devel/.private/navigation)
  ...
  set(navigation_INSTALL_PREFIX /duckietown/catkin_ws/install)
...
if(NOT "/duckietown/catkin_ws/devel/.private/navigation/include " STREQUAL " ")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/duckietown/catkin_ws/devel/.private/navigation/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/duckietown/catkin_ws/src/dt-core/packages/navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /duckietown/catkin_ws/devel/.private/navigation/lib;/duckietown/catkin_ws/devel/lib;/opt/ros/melodic/lib)
