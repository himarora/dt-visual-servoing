...
if("TRUE" STREQUAL "TRUE")
  set(apriltags2_SOURCE_PREFIX /duckietown/catkin_ws/src/dt-core/packages/apriltags2_ros/apriltags2)
  set(apriltags2_DEVEL_PREFIX /duckietown/catkin_ws/devel/.private/apriltags2)
  ...
  set(apriltags2_INSTALL_PREFIX /duckietown/catkin_ws/install)
...
if(NOT "/duckietown/catkin_ws/src/dt-core/packages/apriltags2_ros/apriltags2/include " STREQUAL " ")
  set(apriltags2_INCLUDE_DIRS "")
  set(_include_dirs "/duckietown/catkin_ws/src/dt-core/packages/apriltags2_ros/apriltags2/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/duckietown/catkin_ws/src/dt-core/packages/apriltags2_ros/apriltags2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /duckietown/catkin_ws/devel/.private/apriltags2/lib;/duckietown/catkin_ws/devel/lib;/opt/ros/melodic/lib)
