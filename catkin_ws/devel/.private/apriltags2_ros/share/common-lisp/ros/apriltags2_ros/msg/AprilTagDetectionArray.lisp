...
(cl:in-package apriltags2_ros-msg)
...
(cl:defclass <AprilTagDetectionArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector apriltags2_ros-msg:AprilTagDetection)
   :initform (cl:make-array 0 :element-type 'apriltags2_ros-msg:AprilTagDetection :initial-element (cl:make-instance 'apriltags2_ros-msg:AprilTagDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetectionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetectionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name apriltags2_ros-msg:<AprilTagDetectionArray> is deprecated: use apriltags2_ros-msg:AprilTagDetectionArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AprilTagDetectionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags2_ros-msg:header-val is deprecated.  Use apriltags2_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <AprilTagDetectionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags2_ros-msg:detections-val is deprecated.  Use apriltags2_ros-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagDetectionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'apriltags2_ros-msg:AprilTagDetection))
