...
(cl:in-package apriltags2_ros-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AnalyzeSingleImage-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalyzeSingleImage-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name apriltags2_ros-srv:<AnalyzeSingleImage-request> is deprecated: use apriltags2_ros-srv:AnalyzeSingleImage-request instead.")))
...
(cl:defmethod full_path_where_to_get_image-val ((m <AnalyzeSingleImage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags2_ros-srv:full_path_where_to_get_image-val is deprecated.  Use apriltags2_ros-srv:full_path_where_to_get_image instead.")
...
(cl:defmethod full_path_where_to_save_image-val ((m <AnalyzeSingleImage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags2_ros-srv:full_path_where_to_save_image-val is deprecated.  Use apriltags2_ros-srv:full_path_where_to_save_image instead.")
...
(cl:defmethod camera_info-val ((m <AnalyzeSingleImage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags2_ros-srv:camera_info-val is deprecated.  Use apriltags2_ros-srv:camera_info instead.")
  (camera_info m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AnalyzeSingleImage-request>)))
  ...
  "apriltags2_ros/AnalyzeSingleImageRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnalyzeSingleImage-request)))
  "Returns string type for a service object of type 'AnalyzeSingleImage-request"
  "apriltags2_ros/AnalyzeSingleImageRequest")
...
(cl:defclass <AnalyzeSingleImage-response> (roslisp-msg-protocol:ros-message)
  ((tag_detections
    ...
    :type apriltags2_ros-msg:AprilTagDetectionArray
    :initform (cl:make-instance 'apriltags2_ros-msg:AprilTagDetectionArray)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AnalyzeSingleImage-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalyzeSingleImage-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name apriltags2_ros-srv:<AnalyzeSingleImage-response> is deprecated: use apriltags2_ros-srv:AnalyzeSingleImage-response instead.")))

(cl:ensure-generic-function 'tag_detections-val :lambda-list '(m))
(cl:defmethod tag_detections-val ((m <AnalyzeSingleImage-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags2_ros-srv:tag_detections-val is deprecated.  Use apriltags2_ros-srv:tag_detections instead.")
  (tag_detections m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AnalyzeSingleImage-response>)))
  ...
  "apriltags2_ros/AnalyzeSingleImageResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnalyzeSingleImage-response)))
  "Returns string type for a service object of type 'AnalyzeSingleImage-response"
  "apriltags2_ros/AnalyzeSingleImageResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnalyzeSingleImage)))
  ...
  "apriltags2_ros/AnalyzeSingleImage")