...
bool operator==(const ::apriltags2_ros::AnalyzeSingleImageResponse_<ContainerAllocator1> & lhs, const ::apriltags2_ros::AnalyzeSingleImageResponse_<ContainerAllocator2> & rhs)
{
