...
bool operator==(const ::apriltags2_ros::AprilTagDetectionArray_<ContainerAllocator1> & lhs, const ::apriltags2_ros::AprilTagDetectionArray_<ContainerAllocator2> & rhs)
{
