...
if("TRUE" STREQUAL "TRUE")
  set(easy_algo_SOURCE_PREFIX /duckietown/catkin_ws/src/dt-core/packages/easy_algo)
  set(easy_algo_DEVEL_PREFIX /duckietown/catkin_ws/devel/.private/easy_algo)
  ...
  set(easy_algo_INSTALL_PREFIX /duckietown/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'easy_algo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/duckietown/catkin_ws/src/dt-core/packages/easy_algo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /duckietown/catkin_ws/devel/.private/easy_algo/lib;/duckietown/catkin_ws/devel/lib;/opt/ros/melodic/lib)
