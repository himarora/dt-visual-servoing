...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /duckietown/catkin_ws/src/dt-core/packages/apriltags_ros/apriltags)
  set(apriltags_DEVEL_PREFIX /duckietown/catkin_ws/devel/.private/apriltags)
  ...
  set(apriltags_INSTALL_PREFIX /duckietown/catkin_ws/install)
...
if(NOT "/duckietown/catkin_ws/src/dt-core/packages/apriltags_ros/apriltags/include;/usr/include/eigen3;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/duckietown/catkin_ws/src/dt-core/packages/apriltags_ros/apriltags/include;/usr/include/eigen3;/usr/include;/usr/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/duckietown/catkin_ws/src/dt-core/packages/apriltags_ros/apriltags/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /duckietown/catkin_ws/devel/.private/apriltags/lib;/duckietown/catkin_ws/devel/lib;/opt/ros/melodic/lib)
